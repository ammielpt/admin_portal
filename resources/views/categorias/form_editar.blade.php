        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              ...
              <div class="x_content">
                <br />
                <form id="form_editar_categoria" data-parsley-validate 
                 ...
                 @csrf
                  ...
                  <div class="item form-group">
                    <div class="col-md-6 col-sm-6 offset-md-3">
                      <a href="{{route('categoria.index')}}" class="btn btn-danger" type="button">Cancelar</a>
					  <button class="btn btn-primary" type="reset">Limpiar</button>
                      <button id="btn-subm" type="submit" class="btn btn-success">Guardar</button>
                    </div>
                  </div>
                </form>
              </div>
